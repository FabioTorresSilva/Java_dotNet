...
public class Baralho {
    ...
    public List<Carta> primeirasCartas(int n) {
        ...
        List<Carta> mbar = new ArrayList<>(baralho.subList(0, (n < baralho.size() ? n : baralho.size())));
    ...
    private List<Carta> criarBaralho(Tipo tipoDeBaralho) {
        List<Carta> baralho = (tipoDeBaralho == Tipo.BAR_40 ? new ArrayList<>(40): new ArrayList<>(52));
