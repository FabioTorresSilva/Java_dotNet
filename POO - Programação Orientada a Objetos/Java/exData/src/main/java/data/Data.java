...
public class Data {
    ...
    private final static String[] nomeDiaDaSemana = {"Domingo", "Segunda-feira",
            "Terça-feira", "Quarta-feira",
            "Quinta-feira", "Sexta-feira",
            "Sábado"
    };

    private final static int[] diasPorMes = {0, 31, 28, 31, 30, 31, 30, 31, 31, 30,
            31, 30, 31};

    private final static String[] nomeMes = {"Inválido", "Janeiro", "Fevereiro",
