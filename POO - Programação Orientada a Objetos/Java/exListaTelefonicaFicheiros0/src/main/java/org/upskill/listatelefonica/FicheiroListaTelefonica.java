...
public class FicheiroListaTelefonica {
    ...
    public static final String NOME_FICHEIRO_TEXTO = "ListaTelefonica.txt";
    ...
    public boolean exportarTexto(ListaTelefonica listaTelefonica) {
        return exportarTexto(NOME_FICHEIRO_TEXTO, listaTelefonica);
    }

    public boolean exportarTexto(String nomeFich, ListaTelefonica listaTelefonica) {
        return exportarTexto(new File(nomeFich), listaTelefonica);
    }
    ...
    public ListaTelefonica importarTexto() {
        return importarTexto(new File(NOME_FICHEIRO_TEXTO));
    }

    public ListaTelefonica importarTexto(String nomeFicheiro) {
