...
public class Baralho {
    ...
    /**
     * Compara o baralho com o objeto recebido.
     *
     * @param outroObjecto o objeto a comparar com o baralho.
     * @return true se o objeto recebido representar um baralho equivalente ao
     * baralho. Caso contrário, retorna false.
     */
    @Override
    public boolean equals(Object outroObjecto) {
        ...
        if(this.baralho.size() != outroBaralho.baralho.size())
            return false;

        //ordenar e comparar elemento a elemento: O(log(n)*n)
        List<Carta> outroBaralhoTemp = new ArrayList<Carta>(outroBaralho.baralho);
        List<Carta> baralhoTemp = new ArrayList<Carta>(baralho);

        Collections.sort(outroBaralhoTemp);
        Collections.sort(baralhoTemp);

        return baralhoTemp.equals(outroBaralhoTemp);
    }
