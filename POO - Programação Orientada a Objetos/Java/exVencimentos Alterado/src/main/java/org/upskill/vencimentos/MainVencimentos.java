...
public class MainVencimentos {
    ...
    public static void main(String[] args) {
        ...
        Trabalhador trabalhadorComissao = new TrabalhadorComissao("Susana ", 500, 1500, 6, 321);
        Trabalhador trabalhadorComissao1 = new TrabalhadorComissao("Ferreira ", 500, 1500, 6, 321);
